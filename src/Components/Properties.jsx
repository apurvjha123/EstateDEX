...
const Properties = () => {
  ...
  <div class="card-body">
    ...
    <p class="card-text">Area : {!isLoading?ethers.utils.formatEther(data[2]):console.log(isLoading)} </p>
    <p class="card-text">req : {!isLoading?ethers.utils.formatEther(data[3]):console.log(isLoading)} </p>
  </div>
  <button onClick={call}>Approve</button>
</div>
</form>
    </>
  )
